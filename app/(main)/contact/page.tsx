          ...
          <div className="lg:col-span-2 p-6 sm:p-10 flex flex-col gap-6 sm:gap-8 relative" style={{ backgroundColor: '#0d2b6e' }}>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="https://www.facebook.com/profile.php?id=61592880326160" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
                ...
                <a href="https://www.tiktok.com/@medihugco.ltd" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-xl bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
