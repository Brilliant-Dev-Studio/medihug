      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div>
          ...
          >
            <motion.span whileHover={{ scale: 1.045 }} whileTap={{ scale: 0.97 }} className="inline-block">
              <Link href="/register" className="text-white font-semibold px-7 py-3.5 rounded-full text-sm sm:text-base hover:opacity-90 hover:shadow-lg hover:shadow-blue-900/25 transition-all" style={{ backgroundColor: PRIMARY }}>
                {tr.getCareNow}
              </Link>
            </motion.span>
            <motion.span whileHover={{ scale: 1.045 }} whileTap={{ scale: 0.97 }} className="inline-block">
        ...
        <div className="relative mx-auto w-full max-w-sm sm:max-w-md">
          ...
          <motion.div
            ...
            className="absolute top-5 right-2 sm:-right-4"
          >
            <motion.div
              animate={{ y: [0, -6, 0] }}
              transition={{ duration: 3.2, repeat: Infinity, ease: 'easeInOut', delay: 1.2 }}
              whileHover={{ scale: 1.06 }}
              className="flex items-center gap-1.5 bg-white shadow-lg rounded-full pl-2 pr-3.5 py-2"
            >
          ...
          <motion.div
            ...
            className="absolute top-20 sm:top-24 right-0 sm:-right-8"
          >
            <motion.div
              animate={{ y: [0, -6, 0] }}
          ...
          <motion.div
            ...
            className="absolute top-1/3 -translate-y-1/2 -left-4 sm:-left-10"
          >
            <motion.div
              animate={{ y: [0, -7, 0] }}
              transition={{ duration: 3.6, repeat: Infinity, ease: 'easeInOut', delay: 1.4 }}
              whileHover={{ scale: 1.06 }}
              className="text-white rounded-2xl px-4 py-3.5 shadow-lg max-w-32.5"
          ...
          <motion.div
            ...
            className="absolute bottom-24 -left-4 sm:-left-10"
          >
            <motion.div
              animate={{ y: [0, -6, 0] }}
              transition={{ duration: 3.1, repeat: Infinity, ease: 'easeInOut', delay: 1.5 }}
              whileHover={{ scale: 1.04 }}
              className="bg-white shadow-xl rounded-2xl px-4 py-3.5 max-w-60"
            >
          ...
          >
            <motion.div
              ...
              whileHover={{ scale: 1.06 }}
              className="text-white rounded-2xl px-4 py-3.5 shadow-lg max-w-35"
              style={{ backgroundColor: PRIMARY }}
            >
