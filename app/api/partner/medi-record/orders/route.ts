...
import { deriveOrderSteps } from '@/lib/mediRecordSteps';

/* ── GET /api/partner/medi-record/orders — orders containing at least one of this clinic's
 * products, each with a derived step timeline. Same scoping/shape as /api/partner/orders. ── */
export async function GET(req: NextRequest) {
  ...
  const scoped = orders.map(o => {
    ...
    return {
      ...
      cbPayStatus: o.cbPayStatus,
      cbPayPaidAt: o.cbPayPaidAt,
