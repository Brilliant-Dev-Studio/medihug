...
import { Phone, Lock, Eye, EyeOff, Stethoscope, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full opacity-10 blur-3xl" style={{ backgroundColor: PRIMARY }} />
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex items-center gap-1.5 mt-1 px-3 py-1 rounded-full bg-white/8 border border-white/10">
            ...
            <span className="text-xs text-slate-400 font-medium">ဆရာဝန်များအတွက်</span>
          </div>
        </div>
