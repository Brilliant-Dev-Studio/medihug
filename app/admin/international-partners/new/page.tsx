...
export default function NewInternationalPartnerPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      router.push(`/admin/international-partners/${d.clinic.id}`);
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">Add International Partner</h1>
            <p className="text-xs text-gray-400">Fill in the fields and save — shown on /medihug-tourism, kept out of the regular Partners list</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 flex-1">
          ...
          <Section title="About">
            <div>
              ...
              <textarea className={inp + ' resize-none'} rows={5} value={form.aboutMm}
                onChange={e => set('aboutMm', e.target.value)} placeholder="About this partner in Myanmar..." />
            </div>
            <div>
              <label className={lbl}>About (English)</label>
              <textarea className={inp + ' resize-none'} rows={5} value={form.aboutEn}
                onChange={e => set('aboutEn', e.target.value)} placeholder="About this partner..." />
            </div>
          </Section>
        </div>
        ...
        <div className="space-y-5">
          ...
          <Section title="Gallery">
            <p className="text-xs text-gray-400 -mt-2">Extra photos shown on the partner profile (optional)</p>
          ...
          <Section title="Settings">
            <div className="space-y-3">
              {[
                ...
                { key: 'isPartner', label: 'Partner',     desc: 'Show as an active partner' },
              ].map(({ key, label, desc }) => (
