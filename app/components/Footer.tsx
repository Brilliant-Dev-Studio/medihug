        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-5">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="flex items-center gap-3">
              <Image src="/medihug-logo.png" alt="MediHug" width={72} height={72} className="object-contain w-16 h-16 shrink-0" />
              <span className="text-base font-bold text-white">MediHug</span>
            </div>
            <div className="flex flex-wrap items-center gap-2 sm:ml-1.5">
              <a href="https://www.facebook.com/profile.php?id=61592880326160" target="_blank" rel="noopener noreferrer" className="relative w-8 h-8 rounded-full overflow-hidden border border-white/15 hover:border-white/30 transition-colors shrink-0">
                <Image src="/socials/facebook.png" alt="Facebook" fill className="object-cover" />
              </a>
              <a href="https://www.tiktok.com/@medihugco.ltd" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full border border-white/15 hover:border-white/30 transition-colors flex items-center justify-center shrink-0">
              ...
              <a href="viber://chat?number=%2B959784101005" className="w-8 h-8 rounded-full border border-white/15 hover:border-white/30 transition-colors flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white">
              ...
              <a href="tel:09784101005" className="w-8 h-8 rounded-full border border-white/15 hover:border-white/30 transition-colors flex items-center justify-center shrink-0">
                <Phone className="w-3.5 h-3.5 text-white" />
              </a>
              <span className="text-white/70 text-xs font-semibold whitespace-nowrap">09 784 101005</span>
            </div>
          </div>
