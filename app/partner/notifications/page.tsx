...
function Row({ n }: { n: NotificationItem }) {
  const body = (
    <div className={`flex items-start gap-3.5 px-5 py-4 hover:bg-gray-50 transition-colors ${!n.read ? 'bg-blue-50/30' : ''}`}>
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Orders, appointments, and clinic updates</p>
          </div>
        </div>
        {unreadCount > 0 && (
