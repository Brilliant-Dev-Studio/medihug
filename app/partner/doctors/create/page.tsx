...
export default function PartnerCreateDoctorPage() {
  ...
  return (
    <div className="p-4 lg:p-6 max-w-3xl mx-auto flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3 shrink-0">
        <button onClick={() => router.push('/partner/doctors')}
        ...
        <div>
          ...
          <p className="text-xs text-gray-400">Doctor will be linked to your clinic automatically</p>
        </div>
      </div>
